Feature:
  I, as a technician, want to save my performed task for my Manager to see what I did on my workday.
  ...
  Scenario:
    Given I am logged as a technician
    When I save my task with summary with more than 2500 characters
